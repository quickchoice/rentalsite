...
const locationImageBySlug = {
  'myrtle-beach-sc': withBasePath('/rentals/visual/carosel-images/myrtle1.webp'),
  'charleston-sc': withBasePath('/rentals/visual/carosel-images/Charleston1.jpg')
};

const locationTopicImageBySlug = {
  'myrtle-beach-sc': {
    'baby-gear-rentals': {
      src: withBasePath('/rentals/visual/carosel-images/myrtle1.webp'),
      alt: 'Myrtle Beach rental delivery view'
    },
    'beach-gear-rentals': {
      src: withBasePath('/rentals/visual/location-images/myrtle2.jpg'),
      alt: 'Myrtle Beach beach rental view'
    }
  },
  'charleston-sc': {
    'baby-gear-rentals': {
      src: withBasePath('/rentals/visual/carosel-images/Charleston1.jpg'),
      alt: 'Charleston rental delivery view'
    },
    'beach-gear-rentals': {
      src: withBasePath('/rentals/visual/location-images/charleston2.jpg'),
      alt: 'Charleston beach rental view'
    }
  }
};
...
export const serviceLocations = {
  'myrtle-beach-sc': {
    ...
    summary:
      'QuickChoice Rentals delivers baby gear and beach gear rentals in Myrtle Beach, South Carolina.',
    travelContext:
    ...
    answerCards: [
      {
        ...
        text:
          'QuickChoice Rentals offers baby gear, beach gear, and bundles for Myrtle Beach vacations.'
      },
      {
        title: 'Who It Helps',
        text:
          'It is built for vacationing families, grandparents hosting a beach trip, and travelers who want a lighter packing list.'
      },
      {
    ...
    keyPoints: [
      ...
      'Popular rentals include cribs, strollers, chairs, umbrellas, and wagons.'
    ],
    contentSections: [
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'Beach days that call for umbrella, chair, and wagon rentals'
        ]
      },
      {
        ...
        bullets: [
          ...
          'Beach wagon rentals for easier gear transport'
        ]
      }
    ],
    faqs: [
      {
        ...
        answer:
          'QuickChoice Rentals delivers baby gear, beach gear, and bundles in Myrtle Beach, SC.'
      },
      {
      ...
      },
      {
        ...
        answer:
          'Cribs, pack n plays, strollers, high chairs, beach chairs, umbrellas, and wagons are some of the most requested items.'
      }
    ]
  },
  'charleston-sc': {
    ...
    summary:
      `QuickChoice Rentals delivers baby gear and beach gear rentals in Charleston, South Carolina.`,
    travelContext:
    ...
    answerCards: [
      {
        title: `What We Rent`,
        text:
          `QuickChoice Rentals offers cribs, strollers, pack n plays, high chairs, beach gear, and bundles in Charleston.`
      },
      {
        title: `Who It Is For`,
        text:
          `It is designed for families visiting Charleston with babies or kids who want a lighter packing list.`
      },
      {
    ...
    keyPoints: [
      ...
      `Popular Charleston rentals include cribs, strollers, pack n plays, umbrellas, and wagons.`
    ],
    contentSections: [
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          `Beach-focused travel that benefits from rented comfort gear`
        ]
      },
      {
        ...
        bullets: [
          ...
          `Beach gear rentals for lower-stress day trips`
        ]
      }
    ],
    faqs: [
      {
        ...
        answer:
          `QuickChoice Rentals delivers baby gear, beach gear, and bundles in Charleston, SC.`
      },
      {
      ...
      },
      {
        ...
        answer:
          `Cribs, strollers, pack n plays, high chairs, beach umbrellas, and wagons are some of the most common requests.`
      }
    ]
  }
};
    ...
    getPage(location) {
      ...
      return {
        ...
        keyPoints: [
          ...
          'Popular gear includes beach chairs, umbrellas, wagons, and carts.',
...
const rentalPages = [
  ...
  makeRentalPage({
    ...
    answerCards: [
      {
        title: 'What We Rent',
        text:
          'Beach gear rentals include beach chairs, umbrellas, wagons, carts, towels, games, and bundles.'
      },
      {
        title: 'Where We Deliver',
        text:
    ...
    keyPoints: [
      'Prioritizes the highest-intent beach rental terms first: chairs, umbrellas, and wagons.',
    ...
    faqs: [
      {
        ...
        answer:
          'QuickChoice Rentals rents beach chairs, umbrellas, wagons, carts, towels, selected game items, and bundles.'
      },
      {
      ...
      },
      {
        ...
        answer:
          'Most guests start with beach chair rentals, umbrella rentals, and beach wagon rentals because those match the strongest beach-day needs.'
      }
    ],
    relatedLinks: [
  ...
  makeRentalPage({
    ...
    image: withBasePath('/rentals/visual/product-images/bundle/baby-basics.png'),
    intro: [
      'Bundles make booking easier when you already know the kind of setup you need. Instead of piecing everything together one item at a time, you can start with a ready-made group that fits a beach trip, a sleep setup, or the basics for traveling with kids.',
      'They are especially helpful for families who want to pack lighter, make fewer decisions, and have the right gear waiting at their stay.'
    ],
    heroNote: 'Bundle options are available for trips to both Myrtle Beach and Charleston.',
    answerCards: [
      {
      ...
      },
      {
        ...
        text:
          'They give guests a faster path to the right setup, with clear pricing and less back-and-forth.'
      }
    ],
    keyPoints: [
      'Includes both baby and beach bundle options.',
      'Helps families book faster with fewer separate choices.',
      'Makes it easier to move from browsing into checkout.'
    ],
    cardSections: [
      {
        title: 'Featured Bundle Pages',
        intro: 'These featured bundles are built around real inventory and common trip needs.',
        cards: compact([
          buildRentalIntentCard('family-beach-bundle'),
          buildRentalIntentCard('sleep-essentials-bundle'),
          buildRentalIntentCard('baby-basics-bundle'),
    ...
    contentSections: [
      {
        ...
        paragraphs: [
          'Bundles help guests skip the slow part of trip planning. If you already know you need a beach setup, sleep gear, or a simple family starter set, a bundle gets you there faster than building the whole order from scratch.'
        ]
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          'A bundle is a simpler place to start when you want the essentials without comparing every item one by one. It keeps the booking process shorter and usually matches the combinations families need most often.'
      },
      {
        question: 'Do your bundles support both Myrtle Beach and Charleston trips?',
        answer:
          'Yes. You can use these bundle pages when planning a stay in either Myrtle Beach or Charleston.'
      }
    ],
    relatedLinks: [
  ...
  makeRentalPage({
    ...
    intro: [
      ...
      'Transport-focused beach pages are especially useful because they answer a very practical search need and work well with chairs and umbrellas.'
    ],
    heroNote: 'QuickChoice Rentals serves Myrtle Beach and Charleston only.',
    answerCards: [
      {
...
function buildRelatedLocationTopicCard(locationSlug, topicSlug) {
  ...
  if (!page) return null;
  const topicImage = locationTopicImageBySlug[locationSlug]?.[topicSlug];

  return {
    title: page.title,
    href: page.path,
    description: page.intro[0],
    imageUrl: topicImage?.src || serviceLocations[locationSlug]?.image,
    imageAlt: topicImage?.alt || page.title,
  ...
  answerCards: [
    {
      ...
      text:
        'QuickChoice Rentals is a local vacation rental delivery service for baby gear and beach gear rentals.'
    },
    {
      title: 'Where We Deliver',
      text:
...
export const faqPageFaqs = [
  {
    ...
    answer:
      'You can rent baby gear, beach gear, and bundled setups for an easier trip.'
  },
  {
