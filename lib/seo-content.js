...
const locationTopicImageBySlug = {
  'myrtle-beach-sc': {
    ...
    'accessibility-rentals': {
      src: withBasePath('/rentals/visual/location-images/myrtle3.webp'),
      alt: 'Myrtle Beach accessibility rental area view'
    }
  },
  'charleston-sc': {
    'baby-gear-rentals': {
    ...
    'accessibility-rentals': {
      src: withBasePath('/rentals/visual/location-images/charleston3.jpg'),
      alt: 'Charleston accessibility rental area view'
    }
  }
};
