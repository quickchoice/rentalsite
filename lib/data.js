...
export const products = [
  ...
  createProduct('beach-chair-umbrella', 'Beach Chair w/ Umbrella', 'beach', 10.0),
  ...
  createProduct('beach-recliner', 'Beach Recliner', 'beach', 10.0),
  createProduct('beach-tommy-bahama-dry-bag', 'Tommy Bahama Dry Bag', 'beach', 7.0)
];
...
export const bundles = [
  ...
  },
  {
    ...
    discountPercent: 10,
    description: 'Includes: Beach wheelchair and cart.'
  }
];
