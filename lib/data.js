...
const productImageById = {
  ...
  'beach-umbrella': withBasePath('/rentals/visual/product-images-beach/beach-chair-umbrella.png'),
...
const productShortDescriptionById = {
  ...
  'beach-umbrella': 'AMMSUN 8ft beach umbrella with UPF 50+ protection and tilt coverage.',
...
const productSpecsById = {
  ...
  'beach-umbrella': [
    'Offers UPF 50+ UV protection, blocking 98% of ultraviolet rays.',
    'Includes the umbrella, detachable sand anchor, and matching carry bag.',
    'Air-vented canopy and safety bolt help keep it steady on windy days.'
  ],
  'beach-spikeball': [
...
export const categoryIntro = {
  ...
  beach: 'Thanks for your patience. Find below for the Beach Gear offerings.'
};
