...
const productImageById = {
  ...
  'beach-recliner': withBasePath('/rentals/visual/product-images-beach/recliner.png'),
  'beach-tommy-bahama-dry-bag': withBasePath('/rentals/visual/product-images/tommybag.png'),
  'beach-cooler': withBasePath('/rentals/visual/product-images-beach/cooler.png')
};
...
const productShortDescriptionById = {
  ...
  'beach-chair': 'Backpack beach chair with padded shoulder straps for hands-free carrying to the shore.',
  ...
  'beach-cart': 'Beach cart with big wheels and holders for boards and umbrellas for easy trips across the sand.',
  'beach-cornhole': 'Wooden cornhole set with boards and bean bags for family beach games.',
  'beach-towel': 'Soft beach and pool towel set for drying off after surf and swims.',
  'beach-tent': 'Pop-up beach tent with UV protection and ventilation panels for comfortable, shaded days on the sand.',
  'beach-recliner': 'Reclining beach chair with adjustable backrest positions for relaxing comfort on the sand.',
  'beach-tommy-bahama-dry-bag': 'Tommy Bahama waterproof dry bag with a detachable shoulder strap and zippered front pocket for keeping gear dry on the go.',
  'beach-cooler': 'Large insulated cooler to keep drinks and snacks cold all day at the beach.'
};
...
const productSpecsById = {
  ...
  'beach-chair': [
    'Built-in backpack straps let you carry it hands-free, leaving both hands free for the rest of your gear.',
    'No assembly required; simply unfold and go in seconds.',
  ...
  'beach-cart': [
    ...
    'Includes holders for a boogie board and umbrella to keep everything organized.',
    'Wide-wheel design helps carry beach-day essentials in one trip.'
  ],
  'beach-cornhole': [
  ...
  'beach-towel': [
    'Ben Kaufman Joey Beach and Pool Towel set.',
  ...
  'beach-tommy-bahama-dry-bag': [
    'Keeps Gear Dry: made with durable, waterproof 420D TPU-coated fabric to help protect your belongings from splashes, rain, and quick dunks on the water.',
    'Comfortable to Carry: includes a detachable, adjustable shoulder strap so you can carry it hands-free from boat to beach and everywhere in between (strap is packed inside the bag).',
    'Easy-Access Front Pocket: water-resistant zippered pocket keeps small essentials like keys, sunscreen, or a phone close at hand.',
    "Attach & Customize: front webbing lets you clip on accessories or secure extra gear for days when you're carrying a little more."
  ],
  'beach-cooler': [
    'Large-capacity cooler that holds drinks, snacks, and food for a full beach day.',
    'Thick insulation keeps ice cold for extended periods even in summer heat.',
    'Delivered clean with no odors — ready to pack before you head to the shore.'
  ],
};
...
export const products = [
  createProduct('baby-cribs', 'Cribs', 'baby', 16.0),
  createProduct('baby-bassinet', 'Bassinet', 'baby', 14.0),
  createProduct('baby-pack-n-play', 'Pack n Play', 'baby', 14.0),
  createProduct('baby-2-camera-monitor', '2 Camera Monitor', 'baby', 16.0),
  createProduct('baby-1-camera-monitor', 'One Camera Video Monitor', 'baby', 11.0),
  createProduct('baby-slumberpod', 'SlumberPod', 'baby', 11.0),
  createProduct('baby-car-seat-booster', 'Car Seat - Booster', 'baby', 14.0),
  createProduct('baby-car-seat-infant', 'Car Seat - Infant', 'baby', 14.0),
  createProduct('baby-car-seat-convertible', 'Car Seat - Convertible / Toddler', 'baby', 14.0),
  createProduct('baby-high-chair-tray', 'High Chair w/Tray', 'baby', 11.0),
  createProduct('baby-booster-seat-tray', 'Booster Seat w/Tray', 'baby', 8.0),
  createProduct('baby-single-jogging-stroller', 'Single Jogging Stroller', 'baby', 14.0),
  createProduct('baby-double-jogging-stroller', 'Double Jogging Stroller', 'baby', 16.0),
  createProduct('baby-tandem-double-stroller', 'Tandem Double Stroller', 'baby', 16.0),
  createProduct('baby-bouncy-seat', 'Bouncy Seat', 'baby', 9.0),
  createProduct('baby-swing', 'Swing', 'baby', 13.0),
  createProduct('baby-exersaucer', 'Exersaucer', 'baby', 10.0),
  createProduct('baby-gates', 'Gates', 'baby', 10.0),
  createProduct('baby-bath-tub', 'Bath Tub', 'baby', 6.0),
  createProduct('baby-noise-machine', 'Noise Machine', 'baby', 4.0),
  createProduct('beach-chair', 'Backpack Beach Chair', 'beach', 7.0),
  createProduct('beach-chair-umbrella', 'Beach Chair w/ Umbrella', 'beach', 12.0),
  createProduct('beach-umbrella', 'Beach Umbrella', 'beach', 9.0),
  createProduct('beach-wagon', 'Beach Wagon', 'beach', 10.0),
  createProduct('beach-cart', 'Beach Cart', 'beach', 10.0),
  createProduct('beach-towel', 'Beach Towel', 'beach', 2.0),
  createProduct('beach-spikeball', 'Spikeball', 'beach', 5.9),
  createProduct('beach-cornhole', 'Cornhole', 'beach', 9.0),
  createProduct('beach-tent', 'Beach Tent', 'beach', 17.0),
  createProduct('beach-recliner', 'Beach Recliner', 'beach', 12.0),
  createProduct('beach-tommy-bahama-dry-bag', 'Tommy Bahama Dry Bag', 'beach', 9.0),
  createProduct('beach-cooler', 'Cooler', 'beach', 9.0),
];
...
export const bundles = [
  {
    ...
    discountPercent: 10,
    description: 'Includes: Crib, high chair with tray, single stroller, and noise machine. 2-day minimum order.'
  },
  {
...
export const categoryIntro = {
  ...
  beach: 'Beach gear rentals for Myrtle Beach and Charleston, including chairs, umbrellas, wagons, and more.'
};
