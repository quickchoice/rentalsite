...
const productImageById = {
  ...
  'beach-lounge-chair': withBasePath('/rentals/visual/product-images-beach/beach-lounge-chair.png'),
...
const productShortDescriptionById = {
  ...
  'beach-lounge-chair': 'Ostrich Deluxe 3-in-1 reclining beach lounger with adjustable backrest and padded headrest for all-day comfort.',
...
const productSourceUrlById = {
  ...
  'beach-wheelchair': '',
  'beach-tent': '',
  'beach-lounge-chair': 'https://www.target.com/p/ostrich-deluxe-reclining-lounge-chair-3-in-1-folding-outdoor-beach-lounger-blue-stripe/-/A-88059384',
  'beach-recliner': ''
};
...
const productSpecsById = {
  ...
  'beach-lounge-chair': [
    '3-in-1 design: sits flat as a sun lounger, props up as a beach chair, or folds upright for carrying.',
    'Adjustable backrest reclines to multiple positions for reading, napping, or sunbathing.',
    'Heavy-duty frame with padded headrest — suitable for lawn, pool, patio, and beach use.'
  ]
};
...
export const products = [
  ...
  createProduct('beach-lounge-chair', 'Beach Lounge Chair', 'beach', 10.0),
