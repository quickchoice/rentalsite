...
export const products = [
  ...
  createProduct('baby-test-item-a', 'Test Item A', 'baby', 0.5),
  createProduct('baby-test-item-b', 'Test Item B', 'baby', 0.5),
  createProduct('baby-test-item-c', 'Test Item C', 'baby', 0.5),
